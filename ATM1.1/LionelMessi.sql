...
CREATE TABLE CONSULTA_USUARIO (
    ...
    monto_maximo_disponible DECIMAL(18, 2) NOT NULL,           -- Monto máximo disponible para el retiro
    monto_retirado_hoy DECIMAL(18, 2) NOT NULL,  -- Cantidad retirada hasta el momento por el usuario
    saldo DECIMAL(18, 2) NOT NULL,           -- Saldo actual del usuario
