 ...
 */
public class DepositMoneyUser extends javax.swing.JFrame {
MoneyManager MoneyManagerD = new MoneyManager();
    

    /**
     * Creates new form DepositMoneyUser
     */
    public DepositMoneyUser() {
        initComponents();
        this.setLocationRelativeTo(null);
        
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());    
        LabelDen1.setText(String.valueOf(MoneyManagerD.getMoney_1()));
        LabelDen5.setText(String.valueOf(MoneyManagerD.getMoney_5()));
        LabelDen10.setText(String.valueOf(MoneyManagerD.getMoney_10()));
        LabelDen20.setText(String.valueOf(MoneyManagerD.getMoney_20()));
        LabelDen50.setText(String.valueOf(MoneyManagerD.getMoney_50()));
        LabelDen100.setText(String.valueOf(MoneyManagerD.getMoney_100()));
        LabelDen200.setText(String.valueOf(MoneyManagerD.getMoney_200()));
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Escoja las denominaciones a depositar ");
        ...
        jLabel3.setText("Depositar la cantidad");
    ...
    private void Add5FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add5FieldActionPerformed
        MoneyManagerD.setMoney_5( MoneyManagerD.getMoney_5() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(5.00)));
        LabelDen5.setText(String.valueOf("( +" + MoneyManagerD.getMoney_5() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void Add1FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add1FieldActionPerformed
        ...
        MoneyManagerD.setMoney_1( MoneyManagerD.getMoney_1() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(1.00)));
        LabelDen1.setText(String.valueOf("( +" + MoneyManagerD.getMoney_1() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void Add10FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add10FieldActionPerformed
        MoneyManagerD.setMoney_10(MoneyManagerD.getMoney_10() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(10.00)));
        LabelDen10.setText(String.valueOf("( +" + MoneyManagerD.getMoney_10() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void Add20FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add20FieldActionPerformed
        MoneyManagerD.setMoney_20(MoneyManagerD.getMoney_20() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(20.00)));
        LabelDen20.setText(String.valueOf("( +" + MoneyManagerD.getMoney_20() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void Add50FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add50FieldActionPerformed
        MoneyManagerD.setMoney_50(MoneyManagerD.getMoney_50() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(50.00)));
        LabelDen50.setText(String.valueOf("( +" + MoneyManagerD.getMoney_50() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void RetireBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RetireBtnActionPerformed
        ...
        if(!(MoneyManagerD.getTotalMoney().compareTo(BigDecimal.ZERO) == 0)){
            int idCajero = GetId();
                    ...
                    try (PreparedStatement checkSQL = conn.prepareStatement(sqlCheck)) {
                        ...
                        try (ResultSet rs = checkSQL.executeQuery()) {
                            if (rs.next()) {
                                ...
                                if (MoneyManagerD.getMoney_1() > currentBilletes1 || MoneyManagerD.getMoney_5() > currentBilletes5
                                    || MoneyManagerD.getMoney_10() > currentBilletes10 || MoneyManagerD.getMoney_20() > currentBilletes20
                                    || MoneyManagerD.getMoney_50() > currentBilletes50 || MoneyManagerD.getMoney_100() > currentBilletes100
                                    || MoneyManagerD.getMoney_200() > currentBilletes200) {
                                    JOptionPane.showMessageDialog(this, "El cajero no tiene las denominaciones suficientes para este retiro.");
                                    return;
                                }

                                int updatedBilletes1 = currentBilletes1 + MoneyManagerD.getMoney_1();
                                int updatedBilletes5 = currentBilletes5 +  MoneyManagerD.getMoney_5();
                                int updatedBilletes10 = currentBilletes10 +  MoneyManagerD.getMoney_10();
                                int updatedBilletes20 = currentBilletes20 +  MoneyManagerD.getMoney_20();
                                int updatedBilletes50 = currentBilletes50 +  MoneyManagerD.getMoney_50();
                                int updatedBilletes100 = currentBilletes100 +  MoneyManagerD.getMoney_100();
                                int updatedBilletes200 = currentBilletes200 +  MoneyManagerD.getMoney_200();
                                ...
                                try (PreparedStatement updateStmt = conn.prepareStatement(updateSQL)) {
                                    ...
                                    if (rowsAffected > 0) {
                                        BigDecimal newSaldo = SharedUserDATA.getSaldoUser().add(MoneyManagerD.getTotalMoney());
                                        String updateUserSQL = "UPDATE CREAR_USUARIOS SET saldo = ? WHERE id_usuario = ?";
                                        try (PreparedStatement updateUserStmt = conn.prepareStatement(updateUserSQL)) {
                                            //BigDecimal test = new BigDecimal(SharedUserDATA.getMontoRetiradoHoy().add(MoneyMan.getTotalMoney()));
                                            updateUserStmt.setBigDecimal(1, newSaldo);
                                            
                                            updateUserStmt.setInt(2, SharedUserDATA.getId_usuario());
                                            SharedUserDATA.setSaldoUser(newSaldo);
                                            int updateUserResult = updateUserStmt.executeUpdate();
                                            if (updateUserResult > 0) {

                                                String insertTransactionSQL = "INSERT INTO TRANSACCIONES (id_usuario, id_cajero, tipo_transaccion, monto, token, tokenTransaccion) VALUES (?, ?, 'Deposito', ?, ?, ?)";
                                                try (PreparedStatement insertTransactionStmt = conn.prepareStatement(insertTransactionSQL)) {
                                                    ...
                                                    insertTransactionStmt.setBigDecimal(3, MoneyManagerD.getTotalMoney());
                                                    ...
                                                    if (transactionResult > 0) {
                                                        ...
                                                        JOptionPane.showMessageDialog(this, "Deposito exitoso. El saldo ha sido actualizado.");
                                                    } else {
    ...
    private void Add200FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add200FieldActionPerformed
        MoneyManagerD.setMoney_200(MoneyManagerD.getMoney_200() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(200.00)));
        LabelDen200.setText(String.valueOf("( +" + MoneyManagerD.getMoney_200() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void Add100FieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add100FieldActionPerformed
        MoneyManagerD.setMoney_100(MoneyManagerD.getMoney_100() + 1);
        MoneyManagerD.setTotalMoney(MoneyManagerD.getTotalMoney().add(BigDecimal.valueOf(100.00)));
        LabelDen100.setText(String.valueOf("( +" + MoneyManagerD.getMoney_100() + " )"));
        CantidaTotalDisplay.setText(MoneyManagerD.getTotalMoney().toString());
    ...
    private void CancelAllBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelAllBtnActionPerformed
        MoneyManagerD.setMoney_1(0);
        MoneyManagerD.setMoney_5(0);
        MoneyManagerD.setMoney_10(0);
        MoneyManagerD.setMoney_20(0);
        MoneyManagerD.setMoney_50(0);
        MoneyManagerD.setMoney_100(0);
        MoneyManagerD.setMoney_200(0);
        // idk how to change the decimal value jajahajaja
        MoneyManagerD.setTotalMoney(BigDecimal.valueOf(0.00));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepositMoneyUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DepositMoneyUser().setVisible(true);
            }
        });
    }
